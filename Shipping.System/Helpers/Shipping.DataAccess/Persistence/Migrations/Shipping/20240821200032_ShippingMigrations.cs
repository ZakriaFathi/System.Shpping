...
{
    /// <inheritdoc />
    public partial class ShippingMigrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cities_Branchs_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Representatives_Branchs_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branchs",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPermissions", x => new { x.CustomerId, x.PermissionId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_UserPermissions_Users_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountOfItems = table.Column<int>(type: "int", nullable: true),
                    ...
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RepresentativesId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    BranchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Representatives_RepresentativesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_RepresentativesId",
                table: "Orders",
